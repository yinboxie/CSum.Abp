...
namespace Volo.Abp.Domain.Entities
{
    ...
    /// </summary>
    [Serializable]
    public abstract class BasicInfoEntity<TKey> : AuditedAggregateRoot<TKey>, IHasSimpleSpelling, IPassivable, ISortable, IMultiTenant
    {
        #region 属性
        /// <summary>
        /// 主键
        ...
        public BasicInfoEntity([NotNull]string name, string code,  Guid? tenantId = null)
        {
