...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        public static IServiceCollection AddCSumDefaultRepositroy<TDbContext>(
        ...
        private static Type GetDefaultRepositoryImplementationType(Type dbContextType,Type entityType)
        {
            ...
            {
                return typeof(CSumEfCoreRepository<,>).MakeGenericType(dbContextType, entityType);
            }

            return typeof(CSumEfCoreRepository<,,>).MakeGenericType(dbContextType, entityType, primaryKeyType);
        }
    }
}
